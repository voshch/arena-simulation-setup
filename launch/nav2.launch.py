...
def generate_launch_description():
    ...
    task_generator_namespace = LaunchArgument("task_generator_namespace")
    ...
    substitutions = YAMLMergeSubstitution(
        YAMLFileSubstitution(
            PathJoinSubstitution([ss_root, "configs", "nav2", "model_params.yaml"])
        ),
        YAMLFileSubstitution(
            PathJoinSubstitution(
                [ss_root, "entities", "robots", robot.substitution, "model_params.yaml"]
            )
        ),
        ...
        YAMLFileSubstitution.from_dict(
            {
                ...
                **task_generator_node.dict,
                ...
                "map_frame": PathJoinSubstitution(
                    [task_generator_namespace.substitution, "map"]
                ),
    ...
    substituted_parameters = YAMLReplaceSubstitution(
        obj=YAMLFileSubstitution(
            PathJoinSubstitution([ss_root, "configs", "nav2", "nav2.yaml"])
        ),
            ...
            *(SetRemap(src=r[0], dst=r[1]) for r in remappings),
            ...
            GroupAction(
                    ...
                    Node(
                        ...
                        parameters=[
                            {
                                ...
                                "global_frame_id": "map",
                                "map_topic": "map",
                                "odom_frame_id": PathJoinSubstitution(
                                    [frame.substitution, robot_odom_frame]
                                ),
                                "base_frame_id": PathJoinSubstitution(
                                    [frame.substitution, robot_base_frame]
                                ),
                        ...
                        remappings=[
                            (
                                "/map",
                                PathJoinSubstitution(
                                    [task_generator_node.substitution, "map"]
                                ),
                            ),
                            (
                                "initialpose",
                ...
                condition=IfCondition(
                    PythonExpression(["'", amcl.substitution, "' == 'true'"])
                ),
            ),
            # # Navigation Stack
